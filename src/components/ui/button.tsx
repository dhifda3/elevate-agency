  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground text-base font-medium tracking-wide hover:bg-gray-800 shadow-lg hover:shadow-xl",
        heroOutline: "border-2 border-primary bg-transparent text-primary text-base font-medium tracking-wide hover:bg-primary hover:text-primary-foreground",
      },
      size: {
